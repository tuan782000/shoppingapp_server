...
const dbUrl = `mongodb+srv://${process.env.DATABASE_USERNAME}:${process.env.DATABASE_PASSWORD}@cluster0.wq5t0jf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
